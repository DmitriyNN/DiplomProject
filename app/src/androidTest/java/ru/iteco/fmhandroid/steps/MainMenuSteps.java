...
public class MainMenuSteps extends BasePage {
        ...
        public static void menuConsist() {
            ...
            mainPageButton.check(matches(withText(MainMenuSteps.mainPageTextRu)));
            newsPageButton.check(matches(isDisplayed()));
            newsPageButton.check(matches(withText(MainMenuSteps.NewsPageTextRu)));
            aboutPageButton.check(matches(isDisplayed()));
            aboutPageButton.check(matches(withText(MainMenuSteps.aboutPageTextRu)));
            claimPageButton.check(matches(isDisplayed()));
            claimPageButton.check(matches(withText(MainMenuSteps.claimPageTextRu)));
        }
}
